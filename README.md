...
| [`docs/PLAN_TARIFAS_CLIENTE.md`](docs/PLAN_TARIFAS_CLIENTE.md) | Tarifas acordadas con el cliente (tramos por milla, espera, reserva, no-show, cancelaciones). **Implementado en backend y panel**; lo que falta en la app queda documentado para su equipo |
